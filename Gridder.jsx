        ...
        if(selLayers.length>1){
            ...
            //======================
                ...
                if(nullExists == false){
                    ...
                    thisObj.nullControl.effect(7).slider.expression = "if(effect(9)(1) == true) effect(6)(1) else value";
                    thisObj.nullControl.effect(8).slider.expression = "if(effect(9)(1) == true) effect(6)(1) else value";
                }
